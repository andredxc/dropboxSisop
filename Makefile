...
all: dropboxClient.o dropboxServer.o
	g++ -o clientDropbox $(CLIENT_DIR)mainClient.cpp dropboxClient.o -lpthread
	g++ -o serverDropbox $(SERVER_DIR)mainServer.cpp dropboxServer.o -lpthread
...
clean:
	rm $(CLIENT_DIR)*.o $(SERVER_DIR)*.o clientDropbox serverDropbox
